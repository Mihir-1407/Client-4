...
include '../config.php';
    ...
    try{
        if(isset($_POST["schedule"])){
            ...
            $sqlL -> bind_param('ssssssssssss', $lec_id, $tutor_id, $stu_id, $subject, $sdate, $stime, $etime, $duration, $conducted, $payment, $submitted, $remark);
            $sqlL -> execute();
...
<section>
    ...
    <div class="form">  
        <form action="<?php $_SERVER["PHP_SELF"]?>" class="a_form" method="post" autocomplete="off">
            ...
            <input type="date" name="sdate" id="sdate" min='<?php echo $curr_date?>' placeholder="" required>
